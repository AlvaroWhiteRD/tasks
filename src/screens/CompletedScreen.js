...
import { DeleteTask, GetDBConnection, GetTasksCompleted, UpdateTasks } from '../database/Connection';
...
const CompletedScreen = () => {
  ...
  async function fetchData(){
    try{
     ...
     const data = await GetTasksCompleted(db);
     setTasks(data)
     setDb(db)
